...
public record ChapterInfo
{
    ...
    public ChapterInfo(Guid id, string title, string description, string url, DateTime published, TimeSpan? duration, ShowInfo show) =>
        (Id, Title, Description, Url, Published, Duration, Show) = (id, title, description, url, published, duration, show);

    public ChapterInfo(Show show, Episode episode)
